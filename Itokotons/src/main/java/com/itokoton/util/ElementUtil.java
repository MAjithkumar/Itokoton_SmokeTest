...
//
	...
	public static void SLEEP_500MS() throws InterruptedException {
		Thread.sleep(500);
	}

	public static void SLEEP_1S() throws InterruptedException {
		Thread.sleep(1000);
	}

	public static void SLEEP_2S() throws InterruptedException {
		Thread.sleep(2000);
	}

	public static void SLEEP_3S() throws InterruptedException {
		Thread.sleep(3000);
	}

	public static void SLEEP_4S() throws InterruptedException {
		Thread.sleep(4000);
	}

	public static void SLEEP_5S() throws InterruptedException {
		Thread.sleep(5000);
	}

	public static void SLEEP_6S() throws InterruptedException {
		Thread.sleep(6000);
	}

	public static void SLEEP_7S() throws InterruptedException {
		Thread.sleep(7000);
	}

	public static void SLEEP_8S() throws InterruptedException {
		Thread.sleep(8000);
	}

	public static void SLEEP_25S() throws InterruptedException {
		Thread.sleep(25000);
	}
